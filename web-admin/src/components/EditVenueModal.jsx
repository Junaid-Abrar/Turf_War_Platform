...
const EditVenueModal = ({ show, venue, handleClose, onVenueUpdated }) => {
  const [formData, setFormData] = useState({
    name: '', description: '', location: '', pricePerHour: '',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(err.response?.data?.error || 'Failed to update venue');
    } finally {
      setLoading(false);
    }
  };
      ...
      <Modal.Body>
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="number" name="pricePerHour" required min="0" step="0.01"
